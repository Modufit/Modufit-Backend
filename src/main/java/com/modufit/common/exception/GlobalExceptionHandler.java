package com.modufit.common.exception;

import com.modufit.common.ApiResponse;
import com.modufit.common.BaseCode;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBadCredentials(BadCredentialsException exception) {
        ...
        return ResponseEntity
                ...
                .body(ApiResponse.error(
                        BaseCode.USER_LOGIN_FAIL.getCode(),
                        BaseCode.USER_LOGIN_FAIL.getStatus(),
                        BaseCode.USER_LOGIN_FAIL.getMessage()
                ));
    }
